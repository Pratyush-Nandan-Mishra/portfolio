                                ...
                                >
                                    <div className="relative w-full h-full">
                                        ...
                                        <div
                                            ...
                                            className={`absolute inset-0 w-full h-full bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800 items-center justify-center z-20 ${project.image ? 'hidden' : 'flex'}`}
                                        >
                                            <div className="text-center">
